 ...
 */
@Configuration
@EnableConfigurationProperties(com.easy.cache.spring.CacheProperties.class)
...
public class EasyCacheAutoConfiguration {
    ...
    public CacheManager cacheManager(com.easy.cache.spring.CacheProperties properties) {
